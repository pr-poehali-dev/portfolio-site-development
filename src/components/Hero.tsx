      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
            Создаю эпические приключения в мире блоков. Строительство, выживание, 
            PvP и крутые моды — всё для твоих лучших Minecraft моментов!
          </p>
        </div>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105">
            <Icon name="Play" size={20} className="mr-2" />
            Смотреть на YouTube
          </Button>
          
          <Button variant="outline" size="lg" className="border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300">
